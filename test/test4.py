...
import requests
import numpy as np
from code4 import construct_prompt, parse_output
import logging
import sys
import os
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join('result', 'test4.log'), encoding='utf-8'),
...
def call_llm_api(messages, model="deepseek/deepseek-chat:free", temperature=0):
    """
    调用OpenRouter API
