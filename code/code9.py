...
def construct_prompt(d):
    ...
    example_user_content = (
        ...
        "用户观看过的电影列表:\n"
        "- Liar Liar (ID: 123) - Comedy\n"
        "- The Mask (ID: 456) - Comedy\n"
        "- Mrs. Doubtfire (ID: 789) - Comedy\n"
        "- Toy Story (ID: 246) - Animation, Children's, Comedy\n"
        "- The Lion King (ID: 357) - Animation, Children's, Musical\n\n"
        
        "候选电影列表:\n"
        "- Ace Ventura: Pet Detective (ID: 111) - Comedy\n"
        "- Forrest Gump (ID: 222) - Comedy, Drama, Romance\n"
        "- The Shawshank Redemption (ID: 333) - Drama\n"
        "- Aladdin (ID: 444) - Animation, Children's, Comedy\n"
        "- Terminator 2: Judgment Day (ID: 555) - Action, Sci-Fi, Thriller\n"
    )
    ...
    example_assistant_content = (
        ...
        "```json\n"
        "{\"类别偏好\": {\"Animation\": 0.22, \"Comedy\": 0.44, \"Children's\": 0.22, \"Musical\": 0.11, \"Romance\": 0.0, \"Adventure\": 0.0, \"Action\": 0.0, \"Thriller\": 0.0, \"Drama\": 0.0, \"War\": 0.0, \"Sci-Fi\": 0.0, \"Western\": 0.0, \"Fantasy\": 0.0, \"Horror\": 0.0, \"Crime\": 0.0, \"Film-Noir\": 0.0, \"Documentary\": 0.0}}\n"
        "```\n\n"
        ...
        "| 电影 | 风格类别 | 与用户偏好匹配 |\n"
        "|------|------------|------------|\n"
        "| Ace Ventura: Pet Detective | Comedy | 高 (Comedy: 0.44) |\n"
        "| Forrest Gump | Comedy, Drama, Romance | 中 (Comedy: 0.44) |\n"
        "| The Shawshank Redemption | Drama | 低 (无匹配类别) |\n"
        "| Aladdin | Animation, Children's, Comedy | 高 (Comedy: 0.44, Animation: 0.22, Children's: 0.22) |\n"
        "| Terminator 2 | Action, Sci-Fi, Thriller | 低 (无匹配类别) |\n\n"
        
        "根据相似度计算的最终排序结果:\n\n"
        "1. Aladdin (ID: 444) - 相似度: 0.88\n"
        "2. Ace Ventura: Pet Detective (ID: 111) - 相似度: 0.44\n"
        "3. Forrest Gump (ID: 222) - 相似度: 0.44\n"
        "4. The Shawshank Redemption (ID: 333) - 相似度: 0.0\n"
        "5. Terminator 2 (ID: 555) - 相似度: 0.0\n\n"
        
        "[{\"name\": \"Aladdin\", \"id\": 444}, {\"name\": \"Ace Ventura: Pet Detective\", \"id\": 111}, {\"name\": \"Forrest Gump\", \"id\": 222}, {\"name\": \"The Shawshank Redemption\", \"id\": 333}, {\"name\": \"Terminator 2: Judgment Day\", \"id\": 555}]\n"
    )
