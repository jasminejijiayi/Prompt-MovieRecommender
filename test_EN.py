...
import requests
import numpy as np
from code_EN import construct_prompt, parse_output
import logging
import sys
import os
...
# 配置日志，保存到 result/test10.log
logging.basicConfig(
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - %(message)s',
    handlers=[
        logging.FileHandler(os.path.join('result', 'test_EN.log'), encoding='utf-8'),
...
# SiliconFlow API 设置
API_KEY = "sk-iryffgpajborcmfgogwregwrazqgcscbpuuepoxcftoeaxcw"  # 请替换为你的API密钥
API_URL = "https://api.siliconflow.cn/v1/chat/completions"

def call_llm_api(messages, model="Pro/deepseek-ai/DeepSeek-V3", temperature=0):
    """
    调用OpenRouter API
